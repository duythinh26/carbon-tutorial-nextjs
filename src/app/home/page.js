  ...
  return (
    <Grid className="landing-page" fullWidth>
      <Column lg={16} md={8} sm={4} className="landing-page__banner">
        {/* Prevent Multiple navigation landmarks must have unique labels specified with aria-label or aria-labelledby because both Breadcumb and Tabs components use <nav> elements */}
